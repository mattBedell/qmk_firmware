...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all(
    ...
    LT(1, KC_TAB),  KC_Q,            KC_W,    KC_E,     KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,               TD(MEGA_BSLS), LGUI(LALT(KC_X)),
    LCTL_T(KC_ESC), KC_A,            KC_S,    KC_D,     KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,                      LGUI(LALT(KC_Z)),
    TD(MEGA_SHIFT), KC_LSFT,         KC_Z,    KC_X,     KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,               KC_UP,         LGUI(LALT(KC_C)),
    KC_CAPS,        KC_LALT,         KC_LGUI,           KC_NO,            LCTL_T(KC_SPC),   KC_NO,            KC_RGUI, KC_RALT,          KC_LEFT,      KC_DOWN,       KC_RGHT
  ),
  [1] = LAYOUT_all(
